...
/**
 * Main Elementor Eledesir Class
 *
 * The init class that runs the Elementor Eledesir plugin.
 ...
 */
final class Elementor_Eledesir {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-eledesir' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_ELEDESIR ) );
...
// Instantiate Elementor_Eledesir.
new Elementor_Eledesir();
